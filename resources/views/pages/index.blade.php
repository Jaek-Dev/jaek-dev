            ...
            <div class="content about">
                ...
                <div class="row">
                    <div class="col col-d-6 col-t-6 col-m-12 border-line-v">
                        <div class="text-box">
                            <p>
                                I am hardworking and self-motivated; a software engineer with  a resolute mindset.
                                I am always enthusiastic about new challenging opportunities. My goal is to attain
                                personal and career advancement through shared value. I am positive minded and result oriented.
                            </p>
                        </div>
                    </div>
                    <div class="col col-d-6 col-t-6 col-m-12 border-line-v">
                ...
                <div class="row client-items">
                    ...
                    <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                        <div class="client-item">
                            <div class="image">
                                <a target="_blank" href="../../../external.html?link=https://www.google.com/">
                                    <img src="{{\asset('assets/img/clients/client_1.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                        <div class="client-item">
                            <div class="image">
                                <a target="_blank" href="../../../external.html?link=https://www.google.com/">
                                    <img src="{{\asset('assets/img/clients/client_2.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                        <div class="client-item">
                            <div class="image">
                                <a target="_blank" href="../../../external.html?link=https://www.google.com/">
                                    <img src="{{\asset('assets/img/clients/client_3.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                        <div class="client-item">
                            <div class="image">
                                <a target="_blank" href="../../../external.html?link=https://www.google.com/">
                                    <img src="{{\asset('assets/img/clients/client_4.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="owl-carousel">
                                <div class="item">
                                    <div class="revs-item">
                                        ...
                                        <div class="user">
                                            <div class="img"><img src="{{\asset('assets/img/man1.jpg')}}" alt="" /></div>
                                            <div class="info">
            ...
            <div class="content works">
                ...
                <div class="row grid-items border-line-v">
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="{{\asset('assets/img/works/work1.jpg')}}" class="has-popup-image">
                                    <img src="{{\asset('assets/img/works/work1.jpg')}}" alt="" />
                                    <span class="info">
                            ...
                            <div class="desc">
                                <a href="{{\asset('assets/img/works/work1.jpg')}}" class="name has-popup-image">Motorcycle Helmet</a>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item video border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="../../../external.html?link=https://vimeo.com/97102654" class="has-popup-video">
                                    <img src="{{\asset('assets/img/works/work2.jpg')}}" alt="" />
                                    <span class="info">
                            ...
                            <div class="desc">
                                <a href="../../../external.html?link=https://vimeo.com/97102654" class="name has-popup-video">Minimalism Shapes</a>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="../../../external.html?link=https://w.soundcloud.com/player/?visual=true&amp;url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F221650664&amp;show_artwork=true" class="has-popup-music">
                                    <img src="{{\asset('assets/img/works/work3.jpg')}}" alt="" />
                                    <span class="info">
                        ...
                        <div class="box-item">
                            <div class="image">
                                <a href="#popup-1" class="has-popup-media">
                                    <img src="{{\asset('assets/img/works/work4.jpg')}}" alt="" />
                                    <span class="info">
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="{{\asset('assets/img/works/work5.jpg')}}" class="has-popup-image">
                                    <img src="{{\asset('assets/img/works/work5.jpg')}}" alt="" />
                                    <span class="info">
                                        <span class="ion ion-image"></span>
                                    </span>
                                </a>
                            ...
                            <div class="desc">
                                <a href="{{\asset('assets/img/works/work5.jpg')}}" class="name has-popup-image">Gereal Travels</a>
                                <div class="category">Photo</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="../../../external.html?link=https://w.soundcloud.com/player/?visual=true&amp;url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F221650664&amp;show_artwork=true" class="has-popup-music">
                                    <img src="{{\asset('assets/img/works/work8.jpg')}}" alt="" />
                                    <span class="info">
                                        <span class="ion ion-music-note"></span>
                                    </span>
                                </a>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12 grid-item video border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="../../../external.html?link=https://vimeo.com/97102654" class="has-popup-video">
                                    <img src="{{\asset('assets/img/works/work6.jpg')}}" alt="" />
                                    <span class="info">
                                        <span class="ion ion-videocamera"></span>
                                    </span>
                                </a>
                            ...
                            <div class="desc">
                                <a href="../../../external.html?link=https://vimeo.com/97102654" class="name has-popup-video">Architecture</a>
                                <div class="category">Video</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-item">
                            <div class="image">
                                <a href="#popup-2" class="has-popup-media">
                                    <img src="{{\asset('assets/img/works/work7.jpg')}}" alt="" />
                                    <span class="info">
                                        <span class="ion ion-images"></span>
                                    </span>
                                </a>
            ...
            <div class="content blog">
                <div class="float-right">
                    <div class="title">
                        ...
                        <a href="{{\route('blog.index')}}"
                            style="position: absolute; right: 0; top: 0; font-weight: normal; font-size: 70%;"
                        >SEE ALL &nbsp;&rarr;</a>
                    </div>
                </div>  
                ...
                <div class="row border-line-v">
                    ...
                    <div class="col col-d-12 col-t-12 col-m-12 border-line-h">
                        <div class="box-item">
                            <div class="image">
                                <a href="blog-post-new-dark.html">
                            ...
                            <div class="desc">
                                <a href="blog-post-new-dark.html" class="name">By spite about do of do allow blush</a>
                                <div class="category">Design</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-12 col-t-12 col-m-12 border-line-h">
                        <div class="box-item">
                            ...
                            <div class="desc">
                                <a href="blog-post-new-dark.html" class="name">Two Before Arrow Not Relied</a>
